...
<div class="card shadow mb-4" width="100%">
	<div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
		<h6 class="m-0 font-weight-bold ">Manage Paket</h6>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a class="text-light" onclick="return confirm('Apakah Anda Yakin?')" href="/admin/list_paket/hapus_paket/{{ $data->id_paket }}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
						</td>
					</tr>
					@endforeach
				</tbody>
