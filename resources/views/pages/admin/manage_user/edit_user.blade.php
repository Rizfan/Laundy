...
<div class="row">
	<div class="col col-md-6">
		<div class="card shadow">
			...
			<form method="POST" enctype="multipart/form-data" action="/admin/tambah_user/update">
				@csrf
				<div class="card-body">
					...
					<div class=" form-group row mb-4">
						...
						<input type="text" name="username" id="username" value="{{$user->username}}" class="form-control col col-md-7" onkeyup="cek_nis()" placeholder="Username">
					</div>
					...
					<div class=" form-group row mb-4">
						...
						<select class="form-control col col-md-7" name="role">
					...
					<div class=" form-group row mb-4">
						...
						<input type="text" name="email" id="email" class="form-control col col-md-7" value="{{$user->email}}" placeholder="Email" onkeyup="cek_email()">
					</div>
					...
					<div class=" form-group row mb-4">
						<label class="col col-md-4 col-form-label text-md-left">Old Password</label>
