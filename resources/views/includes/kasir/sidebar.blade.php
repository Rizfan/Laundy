...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/kasir/dashboard">
  ...
  <li class="nav-item @if(Request::is('kasir/list_transaksi','kasir/list_transaksi*')) active @endif">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="/kasir/list_transaksi/tambah_transaksi">Tambah Transaksi</a>
      </div>
    </div>
  </li>
